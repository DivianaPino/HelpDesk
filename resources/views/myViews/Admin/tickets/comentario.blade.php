    ...
    <div class="row align-items-stretch no-gutters contact-wrap ">
      <div class="col-md-12 ">
        <div class="form h-100  content-fondo form-respuesta" >
          ...
          <h3 class="tituloComentario">Comentario de la respuesta del Ticket #{{$idTicket}} </h3>
           ...
           @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group mb-3 ml-auto">
                    ...
                    <input type="text" class="form-control" name="fecha_inicio" id="fecha_inicio" value="{{Carbon\Carbon::parse($ticket->fecha_inicio)->format('d-m-Y H:i:s')}}"  disabled>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="fecha_respuesta" id="fecha_respuesta" value="{{$respuesta['created_at']->format('d-m-Y H:i:s')}}"  disabled>
                </div>

                <div class="col-md-6 form-group mb-3">
                    <label for="fecha_respuesta" class="col-form-label">Agente técnico:</label>
                    <input type="text" class="form-control" name="fecha_respuesta" id="fecha_respuesta" value="{{$ticket->asignado_a}}"  disabled>
                </div>
            ...
            <div class="row">
              <div class="col-md-12 form-group mb-3">
                ...
                <textarea class="form-control" name="nivel_satisfaccion" id="nivel_satisfaccion" cols="30" rows="2" disabled >{{$comentario['nivel_satisfaccion']}}</textarea>
              </div>
            </div>
