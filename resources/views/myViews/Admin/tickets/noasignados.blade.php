...
@section('content')
<h1 class="titulo_prin">Tickets no asignados</h1>
<div>
     <div  class="card">
        <div  class="card-body" >
            <table id="tabla_ticketsNA" class="table table-striped table-bordered shadow-lg mt-4 display responsive nowrap" style="width:100%;" >
