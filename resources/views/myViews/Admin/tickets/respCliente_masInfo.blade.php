            ...
            <div class="row align-items-stretch no-gutters contact-wrap">
                <div class="col-md-12">
                   <div class="form h-100">
                        ...
                        <h3>Respuesta - ticket #{{$idTicket}}:  <span class="span-respondido">Respondido</span></h3>
                        @if(session('status'))
                            <p class="alert alert-success">{{ Session('status') }}</p>
                        @endif
                        <form action="/respuesta/mas_info/ticket/{{$idTicket}}/{{$idMasInfo}}" class="mb-5" method="post" id="contactForm" name="contactForm" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
