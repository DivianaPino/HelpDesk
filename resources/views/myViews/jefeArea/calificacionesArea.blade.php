...
@section('content')
<h1 class="titulo_prin_calificacionesArea">Calificaciones de tickets de área(s) del agente</h1>
    
<div>
     <div  class="card">
        <div  class="card-body" >
            <div class="content-btnCalificaciones" >
                 <a  href="/calificaciones/tickets/jefeArea" class="btn btn-primary btn-misCalif">Calificaciones de mis tickets</a>                      
            </div>
            <table id="tabla_todasCalificaciones" class="table table-striped table-bordered shadow-lg mt-4 display responsive nowrap" style="width:100%;" >
               ...
               @foreach ($calificaciones as $ticketCalif )
                    @foreach ($ticketCalif as $calificacion )
                        @php
