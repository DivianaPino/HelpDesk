...
@section('content')
<h1 class="titulo_prin_comentariosArea">Comentarios de tickets de área(s) del agente</h1>
    
<div>
     <div  class="card">
        <div  class="card-body" >
            <div class="content-btnHistorial" >
                 <a  href="/comentarios/tickets/jefeArea" class="btn btn-primary btn-historial">Comentarios de mis tickets</a>                      
            </div>
